...
export async function ensureDefaultAiInstanceForUser(userId: string, backend: "codex" | "hermes" = "hermes", displayName?: string) {
...
export async function resolveOrCreateChannelUser(params: {
  ...
  if (existing[0]) {
    ...
    return {
      ...
      skillBundleId: instance.skillBundleId,
      strategySkillId: instance.strategySkillId,
  ...
  return {
    ...
    skillBundleId: context.skillBundleId,
    strategySkillId: context.strategySkillId,
