...
// 2026-09-05：570s → 840s（T-462 mg 持仓复盘连续贴线后击穿），租约
// DEFAULT_AUTOMATION_RUN_LEASE_MS 同步 15→20 分钟。
const GENERIC_AUTOMATION_ATTEMPT_TIMEOUT_MS = UNLIMITED_EVAL ? 3_600_000 : 840_000;
